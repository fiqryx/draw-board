    ...
    return (
        <section {...props} className={cn('relative z-10 py-20 px-6', className)}>
            <div className="max-w-4xl mx-auto text-center relative">
                <ShineBorder className='rounded-3xl z-[1]' shineColor={["#A07CFE", "#FE8FB5", "#FFBE7B"]} />
                <div className="absolute inset-0 bg-gradient-to-r from-red-600/20 via-purple-600/20 to-blue-600/20 rounded-3xl blur-2xl" />

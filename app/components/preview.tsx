    ...
    return (
        <section {...props} className={cn('relative z-10 py-16 px-6', className)}>
            <div className="max-w-6xl mx-auto">
                <div className="relative overflow-hidden rounded-2xl shadow-2xl dark:border-stone-600 backdrop-blur-lg bg-white/50 dark:bg-stone-900/50 hover:bg-white/70 dark:hover:bg-stone-800/50 transition-all duration-500 hover:scale-[1.02]">
                    <ShineBorder className='z-[1]' shineColor={["#A07CFE", "#FE8FB5", "#FFBE7B"]} />

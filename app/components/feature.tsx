...
function FeatureCard({ icon, title, description, gradient }: {
    ...
    return (
        <div className="relative overflow-hidden group p-8 rounded-2xl backdrop-blur-lg bg-white/50 dark:bg-stone-900/50 border border-gray-300 dark:border-stone-600 hover:bg-white/70 dark:hover:bg-stone-800/50 transition-all duration-500 hover:scale-105 hover:border-gray-400 dark:hover:border-stone-500">
            <div className={`absolute inset-0 bg-gradient-to-br ${gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-500`} />
            <BorderBeam className='hidden group-hover:block' duration={8} size={100} />
